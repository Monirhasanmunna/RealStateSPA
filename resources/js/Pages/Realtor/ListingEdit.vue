...
<template>
    ...
    <MainLayout>
        <BackButtonComponent title="Listing Edit" :href="route('realtor.listing')" class="flex bg-green-500 text-white p-2 rounded-md hover:bg-green-600 transition duration-200" />
